...
import { Table1Data, Table2Data, Table3Data } from "pages/CommonComponent/data"
...
const PostApi = type => {
  let deleteIDArray = JSON.parse(localStorage.getItem(type)) || []
  switch (type) {
    case "Table1Data":
      return Table1Data.filter(i => !deleteIDArray.includes(i.id))
      break
    case "Table2Data":
      return Table2Data.filter(i => !deleteIDArray.includes(i.id))
      break
    case "Table3Data":
      return Table3Data.filter(i => !deleteIDArray.includes(i.id))
      break
